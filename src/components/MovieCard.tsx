    ...
    > */}
      ...
      {showDetails && (
        <Link to={`/movie/${movie.id}`}>
          <div 
          className="absolute w-[100] h-[200] md:w-[200] md:h[300]  lg:w-[350px] lg:h-[400px] 2xl:w-[350px] 2xl:h-[500px] bg-white bg-opacity-100 top-0 left-0 right-0 bottom-0 text-white p-4 rounded-xl flex flex-col justify-around items-center shadow-md overflow-hidden transition-transform hover:scale-105 duration-500"
