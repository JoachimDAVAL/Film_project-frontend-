...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <motion.div
  className="relative place-items-center w-[200px] h-[300px] lg:w-[350px] lg:h-[400px] 2xl:w-[350px] 2xl:h-[500px] mb-5 md:mb-0"
...
>
  <img
    ...
    alt={movie.title}
    className="w-[200px] h-[300px] lg:w-[350px] lg:h-[400px] 2xl:w-[350px] 2xl:h-[500px] object-cover rounded-xl"
    loading="lazy"
  />
