    ...
    > */}
      ...
      {showDetails && (
        <Link to={`/movie/${movie.id}`}>
          <div 
          className="absolute bg-white bg-opacity-100 top-0 left-0 right-0 bottom-0 text-white p-4 rounded-xl flex flex-col justify-around items-center shadow-md overflow-hidden transition-transform lg:hover:scale-105 duration-500 w-full max-w-full"
